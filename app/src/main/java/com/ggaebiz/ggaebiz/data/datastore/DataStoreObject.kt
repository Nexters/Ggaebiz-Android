...
object DataStoreObject {
    ...
    private const val TIMER_RECORD_DATASTORE_NAME = "timer_record_preferences"
    val Context.timerRecordDataStore by preferencesDataStore(TIMER_RECORD_DATASTORE_NAME)
